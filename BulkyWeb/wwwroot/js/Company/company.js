$(document).ready(function () {
    ...
    function initializeDeleteHandlers() {
        ...
        $(document).off('click', '.delete-btn').on('click', '.delete-btn', function (e) {
            ...
            $('#companyNameToDelete').text(companyName || 'Unknown');
    ...
    // Function to load companys
    function loadCompanies(pageIndex, pageSize, searchTerm) {
        $('#loadingSpinner').removeClass('d-none');

        let url = window.appSettings.getCompaniesUrl + `?pageIndex=${pageIndex}&pageSize=${pageSize}`;
        if (searchTerm) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log('AJAX success, updating company container');
    ...
    $(document).on('click', '.page-link', function (e) {
        ...
        loadCompanies(pageIndex, pageSize, searchTerm);
    });
